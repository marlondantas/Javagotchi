...
public class FeedOperacao extends AbstractOperacao {

	public static Logger logger = LoggerFactory.getLogger(FeedOperacao.class);
	...
	public MessageBuilder execute(MessageCreateEvent event, String[] arrayParametros) throws UsuarioNaoExiste, UsuarioNaoTemBichoVitual,OperacaoInvalida, Exception {
		...
		EmbedBuilder embed = MessageController.getEmbed("Alimentando",Color.GRAY);
