...
public class TrainOperacao extends AbstractOperacao {

	public static Logger logger = LoggerFactory.getLogger(TrainOperacao.class);
	...
	public MessageBuilder execute(MessageCreateEvent event, String[] arrayParametros) throws UsuarioNaoExiste, UsuarioNaoTemBichoVitual,OperacaoInvalida, Exception {
		...
		EmbedBuilder embed = MessageController.getEmbed("Ta no hora do show",Color.GRAY);
