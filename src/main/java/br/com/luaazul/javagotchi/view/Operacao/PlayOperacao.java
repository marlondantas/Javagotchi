...
public class PlayOperacao extends AbstractOperacao {

	public static Logger logger = LoggerFactory.getLogger(PlayOperacao.class);
	...
	public MessageBuilder execute(MessageCreateEvent event, String[] arrayParametros) throws UsuarioNaoExiste, UsuarioNaoTemBichoVitual,OperacaoInvalida, Exception {
		...
		EmbedBuilder embed = MessageController.getEmbed("Hora de brincar",Color.gray);
